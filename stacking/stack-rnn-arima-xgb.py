...
# ## Deep Feed-forward Auto-Encoder Neural Network  to reduce dimension +
#Deep Recurrent Neural Network + ARIMA + Extreme Boosting Gradient Regressor
# ### Our target is Close market
google = pd.read_csv('../dataset/GOOG.csv')
eur_myr = pd.read_csv('../dataset/eur-myr.csv')
usd_myr = pd.read_csv('../dataset/usd-myr.csv')
